...
rfile.close()
plateline=contents[0]
words=plateline.split()
platename=words[7]

rates["ENcor"]=0-rates["NEcor"]
data=rates[["Long","Lat","Evel-loc","Nvel-loc","Eerr","Nerr","ENcor","Uvel","STAT"]] # EP NP are plate removed
# add legend velocity
vslat = float(-2.19)
vslong = float(29.38)
...
fig1.text(text="Observations are relative to stable "+platename+" Plate",
    x=29.20,y=-2.145, 
    no_clip=True,
    justify="LB", 
